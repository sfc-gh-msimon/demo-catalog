...
annotated_text(
    ...
    ("Feature",         "Feature",          "#fea","#000"),
    ("Snowsight",       "Front-end",        "#afa","#000")
)

"""
Chaque démo est présentée en vidéo. Quand il y a un lien public, elle est accompagnée de scripts sur Github et de Quickstart.
