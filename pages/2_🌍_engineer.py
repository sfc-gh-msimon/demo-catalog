...
# Toutes industries
#### 🔧 Join elimination
- [Video](https://drive.google.com/file/d/16qU_2BrwPqBnIpZ6J0NtZDKCRqWLBn6B/view?usp=share_link)


### 🏎 Performance optimization
- [Video](https://drive.google.com/file/d/16vgQ-5IkT2bPaxvnqzEOs9kbc_tw-eQt/view?usp=share_link)
...
3. création de tableaux de bords chez Citibike
- [Video](https://drive.google.com/file/d/15nViolkbysKCVbDSV1JcmebOKb7XswLB/view?usp=share_link)
...
3. Des requêtes sur de grandes tables peuvent être accélérées grace à l'architecture des micro-partitions de Snowflake (pruning)
- [Video](https://drive.google.com/file/d/154GzuSZBXUjtSPs_e6LFAWwA9Hg3NoVr/view?usp=share_link)
""")